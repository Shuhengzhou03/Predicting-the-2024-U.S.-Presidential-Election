...
## Measurement
In conducting a statistical analysis of public opinion for the 2024 U.S. Presidential Election, we focus on transforming raw polling data into structured, measurable, and reliable dataset entries. Our aim is to understand shifts in candidate support, particularly for Trump and Harris, by selecting variables that reflect key aspects of polling methodology and public sentiment. Polling agencies gather data through surveys designed to capture representative samples of voter opinions, with each poll result standardized, coded, and organized within the dataset.
...
For **Donald Trump**, the average support rate is 45.08%, with a minimum of 21% and a maximum of 67.6%. In contrast, **Kamala Harris** has an average support rate of 47.57%, with a minimum of 33% and a maximum of 70.1%. This indicates that, in this dataset, Kamala Harris has a slightly higher overall support rate than Donald Trump, with an average rate that is approximately 2.49% higher. Furthermore, her minimum support rate of 33% is significantly higher than Trump’s lowest rate of 21%, suggesting that Harris’s support is more consistent at lower levels. Additionally, her maximum support rate of 70.1% exceeds Trump’s highest rate of 67.6%, indicating that Harris may have reached higher peaks in support in some parts of the data.

In summary, Kamala Harris shows higher average, minimum, and maximum support rates compared to Donald Trump in this dataset. This could imply that Harris has a stronger support base with less fluctuation in her support at the lowest levels. However, these insights are based solely on this sample, and a more comprehensive analysis would require additional context and data sources.
...
Based on average support, the model’s aggregate prediction indicates that Kamala Harris is expected to have higher overall support than Donald Trump, with an average predicted support of 47.15%. Given this outcome, **our model predicts Kamala Harris as the candidate more likely to win**, aligning with historical trends in states where she showed significant predicted support.
...
The Marquette Law School Poll’s methodology, based on information provided by Marquette Law School, employs a **probability panel** approach to ensure sample accuracy and representativeness. This method involves randomly selecting participants from a verified voter database, ensuring that each individual has a known chance of selection. By doing so, the poll captures the diversity of Wisconsin’s population across race, gender, age, and geography. Additionally, the probability panel allows Marquette to track participants over time, offering insight into how opinions on key issues and elections shift.
...
The probability panel methodology has notable strengths. Random sampling reduces selection bias and enhances generalizability, making it a robust tool for capturing statewide opinion trends. Repeated surveys with the same panel also facilitate longitudinal analysis, revealing shifts in public attitudes in response to political events and policy changes. However, panel studies have limitations: participants may experience **panel conditioning**, where repeated exposure influences their responses. Additionally, this method requires substantial resources to recruit and retain a balanced panel, as certain groups may gradually drop out over time, potentially affecting the sample’s representativeness.
...
We will aim for a sample size of approximately 5,000 respondents, using a stratified random sampling method. This approach will ensure representation across demographics such as age, gender, race, education, and geographic location. The sample size allows for a margin of error of ±1.4% at a 95% confidence level, ensuring robust estimates for subgroups.
...
**10. If you choose "Other" in the previous question, please specify the person you most likely to support.**



**11. What issues are most important to you in this election? (Select up to 3)** 
...
**12. How satisfied are you with the current direction of the U.S. government? (Very dissatisfied to Very satisfied)** 
...
**13. How much do you trust the accuracy of public opinion polls? (Highly distrust to Highly trust)** 
...
**14. Have you previously participated in political opinion polls?** 
